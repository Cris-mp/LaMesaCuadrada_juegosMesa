<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="unidades" class="form-control @error('unidades') is-invalid @enderror" value="{{ old('unidades', $juego?->unidades) }}" id="unidades" placeholder="Unidades">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="duracion" class="form-control @error('duracion') is-invalid @enderror" value="{{ old('duracion', $juego?->duracion) }}" id="duracion" placeholder="Duracion">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="edad_min" class="form-control @error('edad_min') is-invalid @enderror" value="{{ old('edad_min', $juego?->edad_min) }}" id="edad_min" placeholder="Edad Min">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="jugadores_max" class="form-control @error('jugadores_max') is-invalid @enderror" value="{{ old('jugadores_max', $juego?->jugadores_max) }}" id="jugadores_max" placeholder="Jugadores Max">
            {!! $errors->first('jugadores_max', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="tipo_id" class="form-control @error('tipo_id') is-invalid @enderror" value="{{ old('tipo_id', $juego?->tipo_id) }}" id="tipo_id" placeholder="Tipo Id">
